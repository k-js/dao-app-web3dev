...
const App = () => {
  ...
  const editionDropAddress = "0xe72c331F141e63771cF062deD8704d6f176E7a99"
  const { contract: editionDrop } = useContract(editionDropAddress, "edition-drop");
  const { contract: token } = useContract('0xa2640e7E79B29Cc708754129627b18d458bb629e', 'token');
  const { contract: vote } = useContract("0x4EC4E449A509A10C0f0FC8955Fe8dF1C9B760688", "vote");
  ...
  }, [nftBalance])// Guarda a quantidade de tokens que cada membro tem nessa variável de estado.
  ...
  const memberList = useMemo(() => {
    ...
    return (
      <div className="landing">
        <h1>BOAS VINDAS ao ECODAO - a DAO dEs GOD NATURE</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1> 🌱 Página dos membros da ECODAO</h1>
        <p>Parabéns por fazer parte desse clube de ecos!</p>
        <div>
          <div>
